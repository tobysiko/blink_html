...
<section id="objectives">
  ...
  middle terrain with a particular terrain on either side of it — and pays <strong>4
  points</strong> if you hold that arrangement when the game ends. The two sides may sit
  <em>anywhere</em> around the middle: a bend counts exactly as a straight line does.</p>
