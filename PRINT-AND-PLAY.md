...
| `Blink-player-board-A4-wall.pdf` / `-bw` | **proposal** — the same board with a WALL column: a shield per tier showing what a fortified unit defends at, 10/12/14/16/18. Print this one instead if you are trying the wall (app: Fortifications → Wall by tier) |
